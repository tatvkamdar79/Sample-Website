...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
  const selectedStyles =
    "relative bg-yellow before:absolute before:w-6 before:h-6 before:rounded-full before:border-2 before:border-amber-400 before:left-[-50%] before:top-[-50%]";

  return (
    <div className="flex flex-col gap-6 fixed top-2/3 right-7">
      <AnchorLink
        className={`${selectedPage === "home" ? selectedStyles : "bg-gray-500"}
      transition duration-300 w-3 h-3 rounded-full`}
        href={"#home"}
